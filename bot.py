...
• При работе с историей — учитывай курс «История нашего края» (с 01.09.2025)
• При работе с математикой — уточняй курс (Алгебра / Геометрия / Вероятность и статистика)
• Используй правильные названия предметов: «Труд (технология)», «Основы безопасности и защиты Родины»
